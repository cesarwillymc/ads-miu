...
public class Lab1 extends javax.swing.JFrame {
    ...
    protected Tool currentTool = new ScribbleTool();
    ...
    protected void addToolbarButtons(JToolBar toolBar) {
        ...
        clearb = new JButton(new ImageIcon("clear.gif"));
        ...
        scribbleb = new JButton(new ImageIcon("scribble.gif"));
        ...
        lineb = new JButton(new ImageIcon("line.gif"));
        lineb.setToolTipText("Draw Lines");
        toolBar.add(lineb);
        // add actionlistener to button
        lineb.addActionListener(this::lineb_actionPerformed);
        rectangleb = new JButton(new ImageIcon("rectangle.gif"));
        rectangleb.setToolTipText("Draw Rectangles");
        toolBar.add(rectangleb);
        // add actionlistener to button
        rectangleb.addActionListener(this::rectangleb_actionPerformed);
        ovalb = new JButton(new ImageIcon("oval.gif"));
        ovalb.setToolTipText("draw ovals");
        toolBar.add(ovalb);
        // add actionlistener to button
        ovalb.addActionListener(this::ovalb_actionPerformed);
        eraseb = new JButton(new ImageIcon("eraser.gif"));
        eraseb.setToolTipText("Eraser");
        toolBar.add(eraseb);
        // add actionlistener to button
        eraseb.addActionListener(this::eraseb_actionPerformed);
    }
    ...
    void scribbleb_actionPerformed(java.awt.event.ActionEvent event) {
        ...
        setCurrentTool(new ScribbleTool());
    }

    void lineb_actionPerformed(java.awt.event.ActionEvent event) {
        System.out.println("line");
        var newTool = new TwoEndsTool();
        newTool.setShape(new LineShape());
    ...
    void rectangleb_actionPerformed(java.awt.event.ActionEvent event) {
        ...
        var newTool = new TwoEndsTool();
        newTool.setShape(new RectShape());
        setCurrentTool(newTool);
    }
