...
public class Lab1 extends javax.swing.JFrame
{
    ...
    protected Context currentTool = new Context();
	...
	public Lab1 ()
	{
        ...
        currentTool.setStrategy(new ScribbleStrategy());
  ...
  protected EventListener makeCanvasListener(ScribbleCanvas canvas) {
    ...
    protected void addToolbarButtons(JToolBar toolBar) {
         ...
         clearb = new JButton(new ImageIcon("../src/images/clear.gif"));
         ...
         scribbleb = new JButton(new ImageIcon("../src/images/scribble.gif"));
         ...
         lineb = new JButton(new ImageIcon("../src/images/line.gif"));
         ...
         rectangleb = new JButton(new ImageIcon("../src/images/rectangle.gif"));
         ...
         ovalb = new JButton(new ImageIcon("../src/images/oval.gif"));
         ...
         eraseb = new JButton(new ImageIcon("../src/images/eraser.gif"));
