...
public class Lab4 extends javax.swing.JFrame implements UpdateMediator {
    ...
    @Override
    public void notifyListener(ActionsEnum action) {
        switch (action){
            case DISABLE_REDO:
            ...
            case DISABLE_UNDO:
                ...
                break;
            case UPDATE_TEXT:
                invoker.executeCommand(new PushCommand(stack, action.getValue()));
                break;
        }
        updateView();
    }
    ...
    void JButtonPop_actionPerformed(java.awt.event.ActionEvent event) {
        invoker.executeCommand(new PopCommand(stack));
    }
    ...
    public void setPushString(String string) {
        invoker.executeCommand(new PushCommand(stack, string));
    }
