...
public class PushDialog extends javax.swing.JDialog
{
	...
	public PushDialog(Mediator parent)
	{
		mediator = parent; // remember the parent frame
	...
	{
		mediator.executeCommand(new PushCommand(mediator.getvStack(), JTextField.getText()));
		dispose();	//close the dialog
	}
}